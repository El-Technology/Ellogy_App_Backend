...
//            new Mock<PaymentCustomerService>(_userRepository.Object, _subscriptionRepository.Object, _mapper);
//    }
...
//        _userRepository.Setup(x => x.AddStripeCustomerIdAsync(It.Is<Guid>(a => a == user.Id), It.IsAny<string>()))
...
//        // Assert
//        _userRepository.Verify(x => x.GetUserByIdAsync(It.Is<Guid>(a => a == user.Id)), Times.Once);
//        _userRepository.Verify(x => x.AddStripeCustomerIdAsync(It.Is<Guid>(a => a == user.Id), It.IsAny<string>()),
//            Times.Once);
