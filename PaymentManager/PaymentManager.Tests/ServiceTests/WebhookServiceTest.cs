...
public class WebhookServiceTest : StripeBaseServiceForTests
{
    ...
    public async Task OrderConfirmationAsync_IfPaymentMode_ShouldUpdatePaymentAndUserWallet()
    {
        ...
        _userRepository.Setup(x => x.UpdateTotalPurchasedTokensAsync(It.IsAny<Guid>(), It.IsAny<int>()));
        ...
        _userRepository.Verify(x => x.UpdateTotalPurchasedTokensAsync(It.IsAny<Guid>(), It.IsAny<int>()), Times.Once);
