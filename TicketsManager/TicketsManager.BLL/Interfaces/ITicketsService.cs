...
public interface ITicketsService
{
    ...
    Task<PaginationResponseDto<TicketResponseDto>> GetTicketsAsync(
    ...
    Task DeleteTicketAsync(Guid ticketId, Guid userIdFromToken);
    ...
    Task<PaginationResponseDto<TicketResponseDto>> SearchTicketsByNameAsync(
