...
//    [Test]
//    public async Task RegenerateJwtAsync_ShouldThrowException_WhenRefreshTokenIsInvalid()
//    {
//        // Arrange
//        var refreshTokenRequestDto = _fixture.Create<RefreshTokenRequestDto>();
//        var user = _fixture.Create<User>();
//        refreshTokenRequestDto.Jwt = await JwtHelper.GenerateJwtAsync(user);
...
//    [Test]
//    public async Task RegenerateJwtAsync_ShouldGenerateNewJWT_WhenDataIsValid()
//    {
//        // Arrange
//        var refreshTokenRequestDto = _fixture.Create<RefreshTokenRequestDto>();
//        var user = _fixture.Create<User>();
