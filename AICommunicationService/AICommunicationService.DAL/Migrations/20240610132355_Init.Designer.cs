            ...
            modelBuilder.Entity("AICommunicationService.DAL.Models.AIPrompt", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Input = "string",
                            JsonSample = "string",
                            Value = "You MUST!!! retrieve data from context of provided document and base your response and communication to the customer on its content. Adjust your response based on these scenarios: 1.The requested feature is available in the provided context, in this case you shall inform the customer and describe the available functionality asking the user how customer wants to handle it. 2.The context gives guidance or provides valuable information for the customer input, here you should use that information in your response. Document context:"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Description = "string",
                            Functions = "[{'name':'Json','parameters':{'type':'object','properties':{'testCase':{'type':'object','properties':{'testCaseId':{'type':'string'},'description':{'type':'string'},'preConditions':{'type':'string'},'testSteps':{'type':'array','items':{'type':'string'}},'testData':{'type':'string'},'expectedResult':{'type':'string'}},'required':['testCaseId','description','preConditions','testSteps','testData','expectedResult']}},'required':['testCase']}}]",
                            Input = "Use case title: ${0}. Use case description: ${1}. Related user stories: ${2}",
                        ...
                        new
                        {
                            ...
                            Functions = "[{'name':'Json','parameters':{'type':'object','properties':{'services':{'type':'array','items':{'type':'object','properties':{'name':{'type':'string'},'description':{'type':'string'},'serviceLink':{'type':'string'}},'required':['name','description','serviceLink']}}},'required':['services']}}]",
                            Input = "Project requirements: {0}.",
                            JsonSample = "Response must follow exactly this JSON structure. Response JSON must not contain new line symbols. You must keep object keys exactly the same so response can be successfully parsed: {'services': [{'name': 'string', 'description': 'string', 'serviceLink': 'string'}]}",
                        ...
                        new
                        {
                            TemplateName = "RegenerateSequenceDiagramTemplate",
                            Description = "string",
                            Functions = "[{'name':'Json','parameters':{'type':'object','properties':{'Code':{'type':'string'}},'required':['Code']}}]",
                            Input = "Project description: ${0}. Key roles: ${1}. Flow of events: ${2}. Use case: ${3}",
                            JsonSample = "Response must follow exactly this JSON structure. Response JSON must not contain new line symbols. You must keep object keys exactly the same so response can be successfully parsed: {\"Code\": \"string\"}",
                        ...
                        new
                        {
                            TemplateName = "RegenerateFlowchartTemplate",
                            Description = "string",
                            Functions = "[{'name':'Json','parameters':{'type':'object','properties':{'Code':{'type':'string'}},'required':['Code']}}]",
                            Input = "Project description: ${0}. Flow of events: ${1}. Use case: ${2}",
                            JsonSample = "Response must follow exactly this JSON structure. Response JSON must not contain new line symbols. You must keep object keys exactly the same so response can be successfully parsed: {\"Code\": \"string\"}",
